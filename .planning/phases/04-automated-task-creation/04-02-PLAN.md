...
must_haves:
  truths:
    - "All AUTO requirements (01-12) have corresponding test methods"
...
**AUTO-08: Responsible transfer (1 test)**
- `test_responsible_transfer_deferred`: Document that this is deferred (no segment.user_id field yet)

**AUTO-09: Date transfer (1 test)**
- `test_date_transfer_deferred`: Document that this is deferred (no segment date fields yet)
...
2. **Requirement coverage:**
   - AUTO-01 through AUTO-12 each have test(s)
   - AUTO-08 and AUTO-09 documented as deferred
...
- [ ] All AUTO requirements have test coverage (08/09 marked deferred)
